...
import com.cdm.hl7.constants.HL7Types.{withName => whichHl7}
import com.cdm.hl7.constants.HL7Types.{HL7, UNKNOWN}
import com.cdm.hl7.enrichment.{EnrichData, EnrichDataFromOffHeap, EnrichedData, NoEnRicher}
import com.cdm.hl7.model.SegmentsState.SegState
import com.cdm.hl7.model.Destinations.Destination
import com.cdm.log.Logg
import com.cdm.utils.DateUtil.{currentTimeStamp => timeStamp}
import com.cdm.utils.Filters.Conditions.{withName => matchCriteria}
import com.cdm.utils.Filters.Expressions.{withName => relationWithNextFilter}
import com.cdm.utils.Filters.MultiValues.{withName => multiValueRange}
...
package object model extends Logg {
  ...
  case class MsgTypeMeta(msgType: com.cdm.hl7.constants.HL7Types.HL7, kafka: String)

  case class ReceiverMeta(msgType: com.cdm.hl7.constants.HL7Types.HL7, wsmq: Set[String], kafka: String)
...
class EnrichCacheManager extends Logg {
  ...
  import com.cdm.hl7.model.{FieldsTransformer, FieldSelector, FieldsCombiner, FieldsStaticOperator, FieldsValidator}
...
object EnrichCacheManager extends Logg {
  ...
  import com.cdm.hl7.model.FieldsTransformer
