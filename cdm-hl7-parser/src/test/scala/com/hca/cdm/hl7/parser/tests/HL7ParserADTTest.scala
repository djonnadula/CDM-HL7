...
class HL7ParserADTTest extends FlatSpec {
    ...
    val msg7 = HL7ParserTestUtils.getMessage(testFileBasePath, messageName7, messageType.toString)
    val res7 = hl7TestSetup.parse(msg7)
    val expected7 = HL7ParserTestUtils.getExpected(testFileBasePath, messageName7, messageType.toString)
    "ADT Message Test 7 (ADT_7)" should "have a match for the parsed output" in {
        assert(res7 === expected7)
    }

    val messageName8 = "ADT_8"
    val msg8 = HL7ParserTestUtils.getMessage(testFileBasePath, messageName8, messageType.toString)
    val res8 = hl7TestSetup.parse(msg8)
    val expected8 = HL7ParserTestUtils.getExpected(testFileBasePath, messageName8, messageType.toString)
    "ADT Message Test 8 (ADT_8)" should "have a match for the parsed output" in {
        assert(res8 === expected8)
    }

    val messageName9 = "ADT_9"
    val msg9 = HL7ParserTestUtils.getMessage(testFileBasePath, messageName9, messageType.toString)
    val res9 = hl7TestSetup.parse(msg9)
    val expected9 = HL7ParserTestUtils.getExpected(testFileBasePath, messageName9, messageType.toString)
    "ADT Message Test 9 (ADT_9)" should "have a match for the parsed output" in {
        assert(res9 === expected9)
    }

    val messageName10 = "ADT_10"
    val msg10 = HL7ParserTestUtils.getMessage(testFileBasePath, messageName10, messageType.toString)
    val res10 = hl7TestSetup.parse(msg10)
    val expected10 = HL7ParserTestUtils.getExpected(testFileBasePath, messageName10, messageType.toString)
    "ADT Message Test 10 (ADT_10)" should "have a match for the parsed output" in {
        assert(res10 === expected10)
    }

    val messageName11 = "ADT_11"
    val msg11 = HL7ParserTestUtils.getMessage(testFileBasePath, messageName11, messageType.toString)
    val res11 = hl7TestSetup.parse(msg11)
    val expected11 = HL7ParserTestUtils.getExpected(testFileBasePath, messageName11, messageType.toString)
    "ADT Message Test 11 (ADT_11)" should "have a match for the parsed output" in {
        assert(res11 === expected11)
    }

    val messageName12 = "ADT_12"
    val msg12 = HL7ParserTestUtils.getMessage(testFileBasePath, messageName12, messageType.toString)
    val res12 = hl7TestSetup.parse(msg12)
    val expected12 = HL7ParserTestUtils.getExpected(testFileBasePath, messageName12, messageType.toString)
    "ADT Message Test 12 (ADT_12)" should "have a match for the parsed output" in {
        assert(res12 === expected12)
    }

    val messageName13 = "ADT_13"
    val msg13 = HL7ParserTestUtils.getMessage(testFileBasePath, messageName13, messageType.toString)
    val res13 = hl7TestSetup.parse(msg13)
    val expected13 = HL7ParserTestUtils.getExpected(testFileBasePath, messageName13, messageType.toString)
    "ADT Message Test 13 (ADT_13)" should "have a match for the parsed output" in {
        assert(res13 === expected13)
    }

    val messageName14 = "ADT_14"
    val msg14 = HL7ParserTestUtils.getMessage(testFileBasePath, messageName14, messageType.toString)
    val res14 = hl7TestSetup.parse(msg14)
    val expected14 = HL7ParserTestUtils.getExpected(testFileBasePath, messageName14, messageType.toString)
    "ADT Message Test 14 (ADT_14)" should "have a match for the parsed output" in {
        assert(res14 === expected14)
    }

    val messageName15 = "ADT_15"
    val msg15 = HL7ParserTestUtils.getMessage(testFileBasePath, messageName15, messageType.toString)
    val res15 = hl7TestSetup.parse(msg15)
    val expected15 = HL7ParserTestUtils.getExpected(testFileBasePath, messageName15, messageType.toString)
    "ADT Message Test 15 (ADT_15)" should "have a match for the parsed output" in {
        assert(res15 === expected15)
    }

    val messageName16 = "ADT_16"
    val msg16 = HL7ParserTestUtils.getMessage(testFileBasePath, messageName16, messageType.toString)
    val res16 = hl7TestSetup.parse(msg16)
    val expected16 = HL7ParserTestUtils.getExpected(testFileBasePath, messageName16, messageType.toString)
    "ADT Message Test 16 (ADT_16)" should "have a match for the parsed output" in {
        assert(res16 === expected16)
    }

    val messageName17 = "ADT_17"
    val msg17 = HL7ParserTestUtils.getMessage(testFileBasePath, messageName17, messageType.toString)
    val res17 = hl7TestSetup.parse(msg17)
    val expected17 = HL7ParserTestUtils.getExpected(testFileBasePath, messageName17, messageType.toString)
    "ADT Message Test 17 (ADT_17)" should "have a match for the parsed output" in {
        assert(res17 === expected17)
    }

    val messageName18 = "ADT_18"
    val msg18 = HL7ParserTestUtils.getMessage(testFileBasePath, messageName18, messageType.toString)
    val res18 = hl7TestSetup.parse(msg18)
    val expected18 = HL7ParserTestUtils.getExpected(testFileBasePath, messageName18, messageType.toString)
    "ADT Message Test 18 (ADT_18)" should "have a match for the parsed output" in {
        assert(res18 === expected18)
    }

    val messageName19 = "ADT_19"
    val msg19 = HL7ParserTestUtils.getMessage(testFileBasePath, messageName19, messageType.toString)
    val res19 = hl7TestSetup.parse(msg19)
    val expected19 = HL7ParserTestUtils.getExpected(testFileBasePath, messageName19, messageType.toString)
    "ADT Message Test 19 (ADT_19)" should "have a match for the parsed output" in {
        assert(res19 === expected19)
    }

    val messageName20 = "ADT_20"
    val msg20 = HL7ParserTestUtils.getMessage(testFileBasePath, messageName20, messageType.toString)
    val res20 = hl7TestSetup.parse(msg20)
    val expected20 = HL7ParserTestUtils.getExpected(testFileBasePath, messageName20, messageType.toString)
    "ADT Message Test 20 (ADT_20)" should "have a match for the parsed output" in {
        assert(res20 === expected20)
    }

    val messageName21 = "ADT_21"
    val msg21 = HL7ParserTestUtils.getMessage(testFileBasePath, messageName21, messageType.toString)
    val res21 = hl7TestSetup.parse(msg21)
    val expected21 = HL7ParserTestUtils.getExpected(testFileBasePath, messageName21, messageType.toString)
    "ADT Message Test 21 (ADT_21)" should "have a match for the parsed output" in {
        assert(res21 === expected21)
    }

    val messageName22 = "ADT_22"
    val msg22 = HL7ParserTestUtils.getMessage(testFileBasePath, messageName22, messageType.toString)
    val res22 = hl7TestSetup.parse(msg22)
    val expected22 = HL7ParserTestUtils.getExpected(testFileBasePath, messageName22, messageType.toString)
    "ADT Message Test 22 (ADT_22)" should "have a match for the parsed output" in {
        assert(res22 === expected22)
    }

    val messageName23 = "ADT_23"
    val msg23 = HL7ParserTestUtils.getMessage(testFileBasePath, messageName23, messageType.toString)
    val res23 = hl7TestSetup.parse(msg23)
    val expected23 = HL7ParserTestUtils.getExpected(testFileBasePath, messageName23, messageType.toString)
    "ADT Message Test 23 (ADT_23)" should "have a match for the parsed output" in {
        assert(res23 === expected23)
    }

    val messageName24 = "ADT_24"
    val msg24 = HL7ParserTestUtils.getMessage(testFileBasePath, messageName24, messageType.toString)
    val res24 = hl7TestSetup.parse(msg24)
    val expected24 = HL7ParserTestUtils.getExpected(testFileBasePath, messageName24, messageType.toString)
    "ADT Message Test 24 (ADT_24)" should "have a match for the parsed output" in {
        assert(res24 === expected24)
    }

    val messageName25 = "ADT_25"
    val msg25 = HL7ParserTestUtils.getMessage(testFileBasePath, messageName25, messageType.toString)
    val res25 = hl7TestSetup.parse(msg25)
    val expected25 = HL7ParserTestUtils.getExpected(testFileBasePath, messageName25, messageType.toString)
    "ADT Message Test 25 (ADT_25)" should "have a match for the parsed output" in {
        assert(res25 === expected25)
    }

    val messageName26 = "ADT_26"
    val msg26 = HL7ParserTestUtils.getMessage(testFileBasePath, messageName26, messageType.toString)
    val res26 = hl7TestSetup.parse(msg26)
    val expected26 = HL7ParserTestUtils.getExpected(testFileBasePath, messageName26, messageType.toString)
