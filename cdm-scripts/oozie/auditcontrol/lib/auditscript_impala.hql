...
substring(d.etl_firstinsert_datetime,1,8) as NLP_Table_Insert_Date,
count(*) as RowCount
...
Full Outer Join cdm_scri.nlp_patient_id_data d
on Trim(d.msh_msg_control_id) = Trim(a.msg_control_id)

Where Upper(Trim(a.process_name)) like '%-RAW'
and (a.msg_control_id is null or b.msg_control_id is null or c.msg_control_id is null or d.msh_msg_control_id is null)
...
group by 1, 2,3,4,5,6,7,8 order by 1 asc, 5 desc;
