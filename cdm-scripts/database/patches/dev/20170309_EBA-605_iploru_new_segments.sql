...
CREATE EXTERNAL TABLE hl7_ze1_data (
	...
	ze1_id String,
	ze1_counter String,
	ze1_observation_identifier String,
	ze1_observation_identifier_equipment_query_mnemonic String,
	ze1_observation_idenfitier_query_text String,
	ze1_observation_sub_id String,
	ze1_observation_value String,
	ze1_unknown String,
	etl_firstinsert_datetime String,
	field_sequence_num String
)
