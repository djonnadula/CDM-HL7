#!/usr/bin/env bash
# /etc/init.d/hl7AvisReceiverWatcher
...
#
### BEGIN INIT INFO
# Provides:          hl7AvisReceiverWatcher
# Required-Stop:     $network
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: Checks with Yarn resource Manager where hl7AvisReceiverWatcher Running or Not
# Description:       Checks with Yarn resource Manager where hl7AvisReceiverWatcher Running or Not. Zeeke will trigger this and Appropriate Action will be taken in case of Failures
