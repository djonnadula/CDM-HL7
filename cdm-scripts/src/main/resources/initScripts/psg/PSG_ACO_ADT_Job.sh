...
SERVICEDIR='/hadoop/cdm/lib/psg-aco-adt'

SERVICE='PSGACOADTJob.jar'

# Java settings
MINHEAP=512
MAXHEAP=512
JMXPORT=50000
CONFIG='/hadoop/cdm/cfg/PSGACOADT.properties'
INVOCATION="java -Xms${MINHEAP}M -Xmx${MAXHEAP}M \
-cp  ${SERVICE}:/opt/cloudera/parcels/CDH/jars/*  com.hca.cdm.job.Hl7Driver ${CONFIG} \
"

# pid file for the daemon
PIDFILE=/var/log/cdm/psg-aco-adt/run/$NAME.pid
LOCKFILE=/var/log/cdm/psg-aco-adt/lock/subsys/$NAME
OUTFILE=/var/log/cdm/psg-aco-adt/logs/logfile
ERRORFILE=/var/log/cdm/psg-aco-adt/logs/errorlog
