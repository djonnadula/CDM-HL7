#!/usr/bin/env bash
# /etc/init.d/hl7CdmAvisWatcher
# version 1.0.0 2016-10-20 (YYYY-MM-DD)
#
# chkconfig: - 86 06
# description: Watches hl7CdmAvis Running On Spark
#
### BEGIN INIT INFO
# Provides:          hl7CdmAvisWatcher
# Required-Stop:     $network
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: Checks with Yarn resource Manager where hl7process Running or Not
# Description:       Checks with Yarn resource Manager where hl7CdmAvis Running or Not. Zeeke will trigger this and Appropriate Action will be taken in case of Failures
