...
SERVICEDIR='/hadoop/cdm/lib/ef_med_admin'

SERVICE='efMedAdminJob.jar'
...
PIDFILE=/var/log/cdm/ef-med-admin/run/$NAME.pid
LOCKFILE=/var/log/cdm/ef-med-admin/lock/subsys/$NAME
OUTFILE=/var/log/cdm/ef-med-admin/logs/logfile
ERRORFILE=/var/log/cdm/ef-med-admin/logs/errorlog
