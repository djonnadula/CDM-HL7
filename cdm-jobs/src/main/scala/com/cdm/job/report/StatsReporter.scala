...
class StatsReporter(private val app: String) extends Logg with Runnable {
  ...
  SegmentsState.values.foreach {
    case PROCESSED => defNotes append ("<p>" + PROCESSED + " : Hl7 has been Successfully Processed in specific stage and Written to Kafka/WSMQ/HBase Destination System Configured</p>")
